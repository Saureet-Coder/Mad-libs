...
root.title('Saureet-Mad Libs Generator')
Label(root, text= 'Mad Libs Generator \n Enjoy the game!' , font = 'arial 20 bold').pack()
Label(root, text = 'Click Any One from the following :', font = 'arial 15 bold').place(x=40, y=80)
...
def madlib1():
    ...
    print('say cheese , the photographer said as the camera flashed! ' + name + ' and I had gone to ' + place +' to get our photos taken on my birthday. The first photo we really wanted was a picture of us dressed as we called ' + animals + ' pretending to be a profession like  ' + profession + '. when we saw the second photo, it was exactly what I wanted. We both looked like ' + things + ' wearing ' + cloth + ' and ' + verb + ' exactly what I had in mind')
...
Button(root, text= 'My Birthday', font ='arial 15', command= madlib1, bg = 'ghost white').place(x=60, y=120)
Button(root, text= 'Apple', font ='arial 15', command = madlib3 , bg = 'ghost white').place(x=60, y=180)
Button(root, text= 'Dream of nature', font ='arial 15', command = madlib2, bg = 'ghost white').place(x=60, y=240)
root.mainloop()